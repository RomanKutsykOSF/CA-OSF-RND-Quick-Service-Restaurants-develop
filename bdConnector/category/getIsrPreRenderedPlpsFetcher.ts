...
export const getIsrPreRenderedPlpsQuery = `
    query Query($siteId: String!) {
        preRenderedPlps: getIsrPreRenderedPlps(siteId: $siteId)
    }
`;

const getIsrPreRenderedPlpsFetcher = async function (
...
export default getIsrPreRenderedPlpsFetcher;
